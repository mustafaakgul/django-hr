...
class Account(AbstractBaseUser, PermissionsMixin):
    ...
    marrital_status = models.CharField(max_length=30, choices=MARRITAL_STATUS, blank=True, null=True)
    military_status = models.CharField(max_length=30, choices=MILITARY_STATUS, blank=True, null=True)
